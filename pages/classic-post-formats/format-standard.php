		...
		<div class="media-body">
			<?php if(has_post_thumbnail( get_the_ID() )) : ?>
				<div class="article-thumbnail">
					<a href="<?php echo get_permalink(); ?>"><img src="<?php echo MintUtils::thumb( get_the_ID(), $thumb_width, null); ?>" width="<?php echo $thumb_width; ?>" alt="" <?php mint_get_retina( get_the_ID(), $thumb_width, null ); ?> /></a>
				</div>
			<?php endif; ?>
