...
<form class="shipping_calculator pull-right" action="<?php echo esc_url( WC()->cart->get_cart_url() ); ?>" method="post">
<style type="text/css">.shipping-calculator-button:after {content:none !important} </style>
	<h2 ><a href="#" class="shipping-calculator-button pull-right" ><?php _e( 'Calculate Shipping', 'woocommerce' ); ?> <span>&darr;</span></a></h2><br>
	...
	<section class="shipping-calculator-form ">
		...
		<p><button type="submit" name="calc_shipping" value="1" class="btn pull-right"><?php _e( 'Update Totals', 'woocommerce' ); ?></button></p>
