...
<?php endif; ?>
		...
		<form method="post" class="login" style="border:0px;padding:0px;">
			...
			<p class="form-row">
				...
				<input name="rememberme" type="checkbox" id="rememberme" value="forever" style="width:15px;height:15px;"  /><?php _e( 'Remember me', 'woocommerce' ); ?>
				</label>
			</p>
...
<?php if ( get_option( 'woocommerce_enable_myaccount_registration' ) === 'yes' ) : ?>
	...
	<div class="col-2">
		...
		<form method="post" class="register" style="border:0px;padding:0px;">
